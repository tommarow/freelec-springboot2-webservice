package org.freelec.book.springboot.config.auth.dto;

import lombok.Builder;
import lombok.Getter;
import org.freelec.book.springboot.domain.user.Role;
...
public class OAuthAttributes {
    ...
    // toEntity() : User Entity를 생성, OAuthAttributes에서 엔티티를 생성하는 시점은 처음 가입할 때이다.
